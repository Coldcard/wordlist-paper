...
decimal_style = ParagraphStyle('tlab', fontName='Courier-Bold', alignment=TA_LEFT, fontSize=6, spaceAfter=2, spaceBefore=0, leading=4)
...
def cell(w):
    ...
    decimal = str(w+1)
    rv = []
    rv.append(Paragraph(decimal, decimal_style))
